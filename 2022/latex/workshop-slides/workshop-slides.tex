...
\begin{frame}[fragile]{Before we start!}
    ...
    \begin{itemize}
        ...
        \item \href{https://www.overleaf.com/read/qxbhmxnvxgdb}{\underline{\color{blue}All materials for this workshop}
...
\begin{frame}[fragile]{\insertsection : Macros and Environments}
    ...
    \begin{tcblisting}{colback=red!5!white,colframe=red!75!black,listing side text,left=2mm,right=2mm,title=Environment Example}
\begin{displaymath}
    \left|
    \begin{array}{cc}
        2-\lambda & 0\\
...
\section{Alignment, Arrays, Cases, Tables}
...
\begin{frame}[fragile]{Matrices}
    ...
    \begin{tcblisting}{colback=red!5!white,colframe=red!75!black,listing side text,left=2mm,right=2mm,title=Matrices}
\[
\begin{pmatrix}
     2-\lambda & 0\\
     4 & 3-\lambda\\
...
\begin{frame}[fragile]{Cases}
    We can use \verb|cases| for piecewise functions!:
    \begin{tcblisting}{colback=red!5!white,colframe=red!75!black,listing side text,left=2mm,right=2mm,title=Cases}
\[H(s) =
\begin{cases}
0 \text{ for } s<0\\
1 \text{ for } s\geq 0\\
...
\begin{itemize}
    ...
    \item \href{https://www.overleaf.com/learn/latex/Defining_your_own_commands}{\color{blue}\underline{Make your own commands and macros}}
    \begin{itemize}
        \item \verb|\newcommand{}[]{}|
